...
* v0.12.next in progress
  * Address [#78](https://github.com/seancorfield/deps-new/issues/78) by adding `:raw-exts` option to `template.edn` to augment the list of file extensions that are not processed for substitutions (and are copied as-is).
...
* v0.10.1 a90029c -- 2025-08-08
  ...
  * Address [#59](https://github.com/seancorfield/deps-new/issues/59) by clarifying how options end up in the `data` hash map.
