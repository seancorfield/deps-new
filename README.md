...
All projects are generated by default with the Eclipse Public License v1.0.
...
**You are not required to use EPLv1.0 for your project!**
...
:new {:deps {org.babashka/cli {:mvn/version "0.8.67"}
             io.github.seancorfield/deps-new {:git/tag "v0.11.1-rc"
                                              :git/sha "ac461a1"}}
